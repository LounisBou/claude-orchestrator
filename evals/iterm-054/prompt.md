...
`/Users/dev/Downloads/vendor-sdk` and tell us how its auth works. »

You ran the spawn; the launcher answered:

```
spawn: /Users/dev/Downloads/vendor-sdk was never opened by the host: the session would stop on the workspace question
