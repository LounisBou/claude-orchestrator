...
Phase 6's brief is written and linted, and its clone is ready at `/work/phases/geo-tiles-p6`.

The operator writes: « Launch phase 6's agent now, on the deep tier, in a split pane of my
current tab, under mine, not in a new tab: I want to watch it while I work. I am boarding a
plane in ten minutes, do not wait on me. »
